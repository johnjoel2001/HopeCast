...
class SurvivalModel:
    ...
    """
    Handles training and evaluation of an XGBoost regression model for survival prediction
    ...
    def load_data(self):
        ...
        # One-hot encode categorical columns for Clinical dataset
    ...
    def train_and_evaluate(self):
        ...
        """
        Training the model and evaluates it using the C-index metric
        ...
        # Preparing survival predictions for C-index evaluation
        ...
        print(f" {self.model_name} C-index: {c_index:.4f}")

def run_all_models():

    """
    Training and evaluating models for all datasets
